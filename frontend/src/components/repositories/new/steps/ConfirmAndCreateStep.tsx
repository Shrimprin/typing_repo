...
type ConfirmAndCreateStepProps = {
...
export default function ConfirmAndCreateStep({
  wizardData,
  isLoading,
  setIsLoading,
  onBack,
  onComplete,
}: ConfirmAndCreateStepProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between">
        ...
        <Button onClick={handleConfirmAndCreate} variant="primary" disabled={isLoading}>
